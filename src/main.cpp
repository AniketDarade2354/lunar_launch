...
int main()
{
    ...
    while(!glfwWindowShouldClose(window))
    {
        ...
        // Rotate continusaly
        shipRotation = shipRotation + 30.0f * deltaTime;    // 45 degress per second
        ...
        shipPos.x = radius * std::cos(glm::radians(currentFrame * 30.0f));
        shipPos.y = radius * std::sin(glm::radians(currentFrame * 30.0f));
